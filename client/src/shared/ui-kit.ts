 ...
 *
 * components/ui/* es de solo lectura — no se puede corregir el JSDoc ahí.
 * Este archivo re-exporta los mismos componentes reales (mismo código,
 * mismo comportamiento) con un tipo permisivo, para que el resto del equipo
 * no tenga que pelear con falsos errores de tipos. Importa SIEMPRE desde
 * aquí, no directo desde components/ui, en cualquier módulo (compras,
 * bancos, cxp, cxc).
 */
